...
outpref <- paste0(indir, "/SPIRE_analysis_")
...
x_var_sets <- list(
  Generalism_score           = c("generalism_score"),
  Pangenome_openness = c("pangenome_openness"),
  Habitat_count = c("habitat_count"),
  Intra_species_nucleotide_diversity = c("intra_species_nucleotide_diversity")
)
