...
# facet grid plot
sample_coeffs_stacked <- cbind(sample_coeffs[1:4], sample_coeffs[11], stack(sample_coeffs[14:19]))
...
sample_coeffs_stacked$ind[sample_coeffs_stacked$ind == "Phi"] <- "Genome fluidity"
sample_coeffs_stacked$ind <- factor(sample_coeffs_stacked$ind, levels = c("Effective population size (Ne)", "Pangenome size (no. genes)", "r/m", "Genome fluidity"))
...
spearmans.rho.bobay.new$ind[spearmans.rho.bobay.new$ind == "Phi"] <- "Genome fluidity"
spearmans.rho.bobay.new$ind <- factor(spearmans.rho.bobay.new$ind, levels = c("Effective population size (Ne)", "Pangenome size (no. genes)", "r/m", "Genome fluidity"))
...
spearmans.rho.bobay.new$Coeff[spearmans.rho.bobay.new$Coeff == "plateau"] <- "Plateau (i)"
...
#p_all_coeffs
ggsave("all_coeffs_Bobay2018_comp.svg", plot = p_all_coeffs, height = 12, width = 18)
