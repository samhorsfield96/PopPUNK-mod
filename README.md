...
```
usage: python __main__.py [-h] [--aln-core ALN_CORE] [--base-freq BASE_FREQ]
                               [--gene-freq GENE_FREQ] [--num-core NUM_CORE]
                               [--num-pan NUM_PAN] [--core-mu CORE_MU] [--acc-mu ACC_MU]
                               [--num-sim NUM_SIM] [--outpref OUTPREF]
                               [--threads THREADS]
...
Input/Output options:
  --aln-core ALN_CORE   Size of core genome alignment (in bases). Default =
                        1140000
  --base-freq BASE_FREQ
